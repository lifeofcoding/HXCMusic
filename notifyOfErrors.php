...
$file = 'logs/javascript-errors.txt';
	// Open the file to get existing content
	$current = file_get_contents($file);
	// Append a new person to the file
	$hash = base64_encode($m);
	if(!strpos($current, $hash)){

		//sendAlert('errors@hxcmusic.me', 'New Javascript Error', "Browser: ".$browser['name']." ".$browser['version']."\nPlatform:".$browser['platform']."\n".$m);
		// Write the contents back to the file
		file_put_contents($file, "Browser: ".$browser['name']." ".$browser['version']."\nPlatform:".$browser['platform']."\n".$m."\nHash: ".$hash."\n\n");
	}
?>