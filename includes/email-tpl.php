<!-- saved from url=(0092)https://hxcmusicmedianetwork.createsend.com/t/ViewEmail/d/071DE2AB40B81376/C67FD2F38AC4859C/ -->
...
@media only screen and (max-width: 660px) { 
    ...
    #top-bar { border-radius:6px 6px 0px 0px; -moz-border-radius: 6px 6px 0px 0px; -webkit-border-radius:6px 6px 0px 0px; -webkit-font-smoothing: antialiased; background-color: #000; color: #888888; }
    ...
    .article-title { font-size: 18px; line-height:24px; color: #b0b0b0; font-weight:bold; margin-top:0px; margin-bottom:18px; font-family: HelveticaNeue, sans-serif; }
...
<![endif]-->
    ...
    <meta property="og:title" content="Welcome to HXCMusic.com!">
  ...
  <body style="width:100% !important;background-color:#c7c7c7;margin-top:0;margin-bottom:0;margin-right:0;margin-left:0;padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;font-family:HelveticaNeue, sans-serif;">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" id="background-table" align="center" style="table-layout:fixed;background-color:#c7c7c7;">
      <tbody>
              ...
              <tbody>
                ...
                <tr style="border-collapse:collapse;">
                  <td class="w640" width="640" style="font-family:HelveticaNeue, sans-serif;border-collapse:collapse;">
                    <table id="top-bar" class="w640" width="640" cellpadding="0" cellspacing="0" border="0" bgcolor="#000000" style="border-radius:6px 6px 0px 0px;-moz-border-radius:6px 6px 0px 0px;-webkit-border-radius:6px 6px 0px 0px;-webkit-font-smoothing:antialiased;background-color:#000;color:#888888;">
                      <tbody>
                        <tr style="border-collapse:collapse;">
                ...
                <tr style="border-collapse:collapse;">
                  <td id="header" class="w640" width="640" align="center" bgcolor="#000000" style="font-family:HelveticaNeue, sans-serif;border-collapse:collapse;">
                          ...
                          <td class="w580" width="580" style="font-family:HelveticaNeue, sans-serif;border-collapse:collapse;">
                            <div align="center" id="headline">
                              <p style="color:#eeeeee;font-family:HelveticaNeue, sans-serif;font-size:36px;text-align:center;margin-top:0px;margin-bottom:30px;">
                                <strong>HXCMusic Media Network</strong>
                              </p>
                            </div>
                          </td>
                          <td class="w30" width="30" style="font-family:HelveticaNeue, sans-serif;border-collapse:collapse;"></td>
                          ...
                          <td class="w580" width="580" style="font-family:HelveticaNeue, sans-serif;border-collapse:collapse;">
                            <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                              <tbody>
                                <tr style="border-collapse:collapse;">
                                  <td class="w580" width="580" style="font-family:HelveticaNeue, sans-serif;border-collapse:collapse;">
                                    <p align="left" class="article-title" style="font-size:18px;line-height:24px;color:#b0b0b0;font-weight:bold;margin-top:0px;margin-bottom:18px;font-family:HelveticaNeue, sans-serif;">
                                      Welcome to HXCMusic.com
                                    </p>
                                    <div align="left" class="article-content" style="font-size:13px;line-height:18px;color:#444444;margin-top:0px;margin-bottom:18px;font-family:HelveticaNeue, sans-serif;">
                                      <p style="margin-bottom:15px;">
                                        You can login and start enjoying legal music downloads, anytime, anywhere!
                                      </p>
                                      <p style="margin-bottom:15px;">
                                        You can login using the details provided:<br style="line-height:100%;">
                                        <strong>Username:</strong> <?=$username?><br style="line-height:100%;">
                                      ...
                                      <p style="margin-bottom:15px;">
                                        If you ever have any problems or questions, please contact us at <a href="http://https//mail.google.com/mail/?view=cm&amp;fs=1&amp;tf=1&amp;to=support@hxcmusic.com" style="color:#2f82de;font-weight:bold;text-decoration:none;" target="_blank">support@hxcmusic.com</a>
                                      </p>
                                    </div>
                                  </td>
                                </tr>
                      ...
                      <tbody>
                        ...
                        <tr style="border-collapse:collapse;">
                          ...
                          <td class="w580" width="360" valign="top" style="font-family:HelveticaNeue, sans-serif;border-collapse:collapse;">
                            <p id="permission-reminder" align="left" class="footer-content-left" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;font-size:12px;line-height:15px;color:#888888;margin-top:0px;margin-bottom:15px;white-space:normal;">
                              <span class="hide"><span>You're receiving this because you recently signed up at HXCMusic.com</span></span>
                            </p>
